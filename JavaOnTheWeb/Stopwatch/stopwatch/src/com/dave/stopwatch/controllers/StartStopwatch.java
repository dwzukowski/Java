...
public class StartStopwatch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//creating a new Watch and storing it in session variable "currentWatch" 
		Watch currentWatch = new Watch();
		session.setAttribute("currentWatch", currentWatch);
		//session data stored as object. Must cast to Watch to access watch methods
		Watch test = (Watch) session.getAttribute("currentWatch");
		System.out.println("current start of watch in session: " + test.getStartTime());
